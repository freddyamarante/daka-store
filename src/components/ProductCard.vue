    ...
    <div class="relative border-b border-teal-800/40 h-[420px] sm:h-[460px] overflow-hidden">
      ...
      <div v-else class="relative w-full h-full p-8">
        <div class="relative bg-teal-700/40 rounded-xl h-full w-full z-20 animate-pulse p-20">
          <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="0.5" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-image-icon lucide-image text-teal-800/30">
